...
if(!function_exists('icon')){
    function icon($src){
        $x =& get_instance();
        return $x->config->base_url('aset/photo/icon/'. $src);
    }
}

if(!function_exists('photo_chat')){
    function photo_chat($src){
        $x =& get_instance();
        return $x->config->base_url('aset/photo/chat/'. $src);
    }
}

if(!function_exists('photo_berita')){
    function photo_berita($src){
        $x =& get_instance();
        return $x->config->base_url('aset/photo/berita/'. $src);
    }
}

if(!function_exists('photo_galeri')){
    function photo_galeri($src){
        $x =& get_instance();
        return $x->config->base_url('aset/photo/galeri/'. $src);
    }
}

if(!function_exists('file_pendaftaran')){
    function file_pendaftaran($src){
        $x =& get_instance();
        return file_get_contents($x->config->base_url('aset/file/pendaftaran/'. $src));
    }
}

if(!function_exists('photo_user')){
    function photo_user($src){
        $x =& get_instance();
        return $x->config->base_url('aset/photo/user/'. $src);
    }
}
...
if(!function_exists('login_admin')){
    function login_admin(){
        $x =& get_instance();
        return $x->session->userdata('_admin') ? TRUE : FALSE;
    }
}
...
if(!function_exists('login_user')){
    function login_user(){
        $x =& get_instance();
        return $x->session->userdata('_user') ? TRUE : FALSE;
    }
}
...
if(!function_exists('encrypt')){
    function encrypt($encrypt){
        $x =& get_instance();
        return $x->encryption->encrypt($encrypt);
    }
}
...
if(!function_exists('decrypt')){
    function decrypt($encrypt){
        $x =& get_instance();
        return $x->encryption->decrypt($encrypt);
    }
}
...
if(!function_exists('visitors')){
    function visitors($dir, $name = null){
        $x =& get_instance();
		$ip = $x->input->ip_address();
		...
		// simpan file menjadi ektensi txt
